...
this mode runs the hook `ess-bugs-mode-hook', as the final or
...
runs the hook `ess-gretl-mode-hook', as the final or penultimate step
during initialization.

\\{ess-gretl-mode-map}" t)
...
this mode runs the hook `ess-julia-mode-hook', as the final or
penultimate step during initialization.

\\{ess-julia-mode-map}" t)
...
this mode runs the hook `ess-mode-hook', as the final or penultimate
...
In addition to any hooks its parent mode might have run, this mode
runs the hook `ess-r-mode-hook', as the final or penultimate step
during initialization.
...
In addition to any hooks its parent mode `ess-transcript-mode' might
have run, this mode runs the hook `ess-r-transcript-mode-hook', as the
final or penultimate step during initialization.

\\{ess-r-transcript-mode-map}" t)
...
the following to your Emacs configuration file:
  ...
  (add-hook \\='Rd-mode-hook #\\='abbrev-mode)" t)
...
In addition to any hooks its parent mode might have run, this mode
runs the hook `SAS-mode-hook', as the final or penultimate step during
initialization.
...
In addition to any hooks its parent mode `ess-mode' might have run,
this mode runs the hook `ess-transcript-mode-hook', as the final or
