...
This is a minor mode.  If called interactively, toggle the `Julia-Snail
...
evaluate the variable `julia-snail-mode'.
...
`Julia-Snail-Repl mode' mode.  If the prefix argument is positive,
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `julia-snail-repl-mode'.
